...
import { getPersonalizedProducts, getRecentlyViewedProducts, getRelatedProducts } from "@/lib/productDiscovery";
import ProductStockStatus from "@/components/ProductStockStatus";
import RelatedProductsSection from "@/components/RelatedProductsSection";
import { DeliveryEstimate } from "@/components/DeliveryEstimate";
import { SimulatedViewerCount } from "@/components/SimulatedViewerCount";
...
export default function ProductDetail() {
  ...
  const personalizedProducts = getPersonalizedProducts(catalogue, recentHandles, product.handle);
